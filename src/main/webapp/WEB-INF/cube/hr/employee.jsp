...
<div class="card-header py-3">
	...
	<a  class="m-0 text-secondary" href="/hr_employeePage">임직원 조회</a>
</div>
<div class="card-body">
  ...
  <table class="table table-bordered text-gray-900" style="width: 100%; cellspacing: 0">
    ...
    <c:forEach var="user" items="${userList}">
        ...
        <tr>
           ...
           <td><a class="btn btn-info" href='<c:url value="/hr_updateEmployee/${user.userId }"><c:param name="page" value="${currentPage }"/></c:url>'>수정하기</a></td>
        </tr>
    </c:forEach>
</tbody>
</table>
