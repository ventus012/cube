...
<div class="card-body p-0">
	<!-- Nested Row within Card Body -->
		...
		<div class="text-center">
			<h1 class="h4 text-gray-900 mt-4 mb-5 font-weight-bold">아이디 찾기</h1>
		</div>
	
		<div class="form-group">
			<input type="text" class="form-control form-control-user"
				id="userNum" name="userNum" placeholder="사번 8자리">
		</div>
		...
		<script>
			...
			userMobileInput.addEventListener('input', function(event) {
				...
				if (!userMobileRegex
					...
					userMobileError.textContent = '휴대전화 번호 11자리를 입력해주세요.';
				} else {
		...
		<div class="form-group">
		<button id="btn-findId" class="btn btn-primary btn-user btn-block">아이디 찾기</button>
